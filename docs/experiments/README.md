...
| TypeSafe Jev evidence routing | [Research brief](typesafe-jev/research-brief.md), [protocol](typesafe-jev/protocol.md), [research log](typesafe-jev/research-log.md), [exposed corpus](typesafe-jev/exposed-routing-corpus.json) | Preflight implementation complete. The adapter is shadow-only and keyless-safe; no live Jev measurement or adoption decision exists. |
