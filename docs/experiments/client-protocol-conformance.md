...
violations. This is a contract fixture, not a public route or a claim that the
existing API has changed. W6 remains open until actual API/CLI/MCP adapters, golden
traces, authorization/deletion races and public-surface inventory are implemented
and reviewed.
