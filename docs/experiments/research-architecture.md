...
| W5 | [Durable execution and recovery](https://github.com/magnus919/groktocrawl-x/milestone/3) | [#111](https://github.com/magnus919/groktocrawl-x/issues/111) | Contract fixture merged by [PR #118](https://github.com/magnus919/groktocrawl-x/pull/118); the bounded Valkey ownership ledger and hosted recovery lane merged in [PR #135](https://github.com/magnus919/groktocrawl-x/pull/135); checkpoint and terminal-projection persistence merged in [PR #137](https://github.com/magnus919/groktocrawl-x/pull/137); durable status recovery and persisted cancellation are merged in [PR #139](https://github.com/magnus919/groktocrawl-x/pull/139); bounded artifact-byte and terminal-event recovery is merged in [PR #142](https://github.com/magnus919/groktocrawl-x/pull/142); provider ambiguity and terminal-race evidence is tracked in [issue #143](https://github.com/magnus919/groktocrawl-x/issues/143); the durable route crash/cancel matrix is under review in [issue #145](https://github.com/magnus919/groktocrawl-x/issues/145), while backup/restore and the infrastructure decision remain open |
