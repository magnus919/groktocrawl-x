...
| W11 | [SlopSearX research substrate integration](https://github.com/magnus919/groktocrawl-x/milestone/10) | [#318](https://github.com/magnus919/groktocrawl-x/issues/318) | Active protocol and harness work; scored comparison still waits for W10. The installed SlopSearX 0.5 image is now the pinned W11 baseline. Its opt-in adaptive continuation, entity grouping, saved-search reports, retrieval receipts and manifests, staged search, and dependency dossiers are split into isolated grant-specific arms. HTTP compatibility passed, all nine grant boundaries passed, and all 31 deterministic contract cases are proved by 114 local test outcomes plus three isolated-Valkey outcomes. W11 retains a single owner boundary: GroktoCrawl owns user intent, evidence gaps, synthesis, and publication; SlopSearX owns bounded retrieval execution, immutable snapshots, provenance, and attempt accounting. Ordinary SearXNG behavior remains unchanged. |
