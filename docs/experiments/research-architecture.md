...
| W4 | Equivalent workflow backends / research + evaluation owner | W2, D7; W3 for persistence cases | **Adapter implemented in merged PR #150:** optional LangGraph runtime runs the same typed fixture policy beside the imperative reference; the first paired 30-repetition-per-workload measurement is recorded in [the 2026-09-08 evidence packet](evidence/runtime-comparison/2026-09-08/), with zero conformance failures. W1 held-out eligibility, bounds review and the D4 decision remain open | 3–5 days |
...
| W4 | [Runtime comparison](https://github.com/magnus919/groktocrawl-x/milestone/2) | [#110](https://github.com/magnus919/groktocrawl-x/issues/110) | Harness merged by [PR #115](https://github.com/magnus919/groktocrawl-x/pull/115); the first paired fixture measurement is recorded in [the 2026-09-08 packet](evidence/runtime-comparison/2026-09-08/), with zero conformance failures. W1 packet eligibility is approved; bounds review and the runtime adoption decision remain open |
