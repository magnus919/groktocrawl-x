...
| W13 | [Pervasive autonomous barrier recovery](https://github.com/magnus919/groktocrawl-x/milestone/12) | [#363](https://github.com/magnus919/groktocrawl-x/issues/363) | In progress. Accepted [ADR-0088](../adr/0088-centralize-bounded-barrier-recovery.md) makes scraper-svc the owner of one classified, bounded recovery ladder and keeps the active W9 deployment frozen while implementation and CI evidence are reviewed. |
