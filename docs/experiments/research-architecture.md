...
| W1 | Architecture decision pack and baseline / architecture + evaluation owner | W0 identity; execution lanes needed for measured baseline | Review D1–D3/D6 contracts, frame D4/D5 alternatives, accept D7 experiment protocol; pin baseline behavior and decisions with measurable unresolved questions. The original packet, isolation review, incumbent run, and [primary semantic review](enterprise-evaluation/w1-incumbent-semantic-review-2026-09-09.md) are complete. Proposed bounds and execution controls are pinned. Candidate B policy 3 produced a complete fixed-source terminal manifest after mechanically decidable structure and conflict checks moved to application-owned verification, then froze at `36f999514cf0dc8eb3164c4cac50a7ba0002618f`. A fresh [replacement packet](enterprise-evaluation/w1-replacement-packet-2026-09-10.md) was independently curated after the freeze, passed structural validation, and received Magnus's isolation approval. The authorized [paired comparison](enterprise-evaluation/w1-comparison-outcome-2026-09-10.md) completed all 300 attempts. Candidate B completed 39/150 versus 77/150 for Arm A, exceeded both latency limits by more than two times, and used 15.7 times the reported tokens. The [semantic learning review](enterprise-evaluation/w1-semantic-learning-review-2026-09-10.md) also found worse strict support, citation correctness, and full-study coverage, while completed B answers showed slightly better subquestion coverage. Candidate B is rejected as the current replacement; the review now directs a leaner evidence-first successor. | 3–5 days |
