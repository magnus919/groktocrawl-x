...
| W8 | Adaptively acquire sufficient evidence / retrieval + research owner | W7 decision | **In progress.** The [first retrieval baseline](enterprise-evaluation/w8-retrieval-baseline-2026-09-11.md) completed 24 of 24 queries against current SlopSearX, finding 17 of 44 exact known-useful URLs. All responses were partial because several engines were blocked or rate-limited; terminology-shift recall was the weakest slice. Comparison variants, source-equivalence audit, replanning, diversity and freshness studies remain. SlopSearX changes must be additive, optional, generally useful and backward compatible. | 5–9 days plus observation |
