...
| W9 | Rehearse the replacement candidate / maintainer + operations owner | W8; accepted deployment manifest | **In progress.** Candidate freeze, matched compatibility, migration and rollback, PostgreSQL authority, pgvector serving, independent agent-use repairs, and the bounded similarity decision have passed. Earlier failed and superseded windows remain retained operational evidence. A separate model comparison recreated the candidate agent with an older image and `free` alias on September 22, ending the prior window before checkpoint 1. The agent was restored to current-main revision `46a528228b1365189cdd38d0bcdb12109a8dc763` and model `general`. The [fresh checkpoint 0](evidence/replacement-rehearsal/2026-09-22-free-model-restart-checkpoint-0/README.md) passed all 12 declared operations after one retained transient gateway failure and the protocol's single retry. Current-window credit is 12/30 operations and 1/3 checkpoints; pgvector serves and Qdrant remains rollback ready. Checkpoint 1 is due no earlier than September 25 at 19:16 UTC, and the seven-day gate no earlier than September 29 at 19:16 UTC. | Earliest completion 2026-09-29T19:16:26.093854409Z, conditional on unchanged configuration and remaining gates |
...
| W9 | [Replacement rehearsal](https://github.com/magnus919/groktocrawl-x/milestone/8) | [#308 deployment](https://github.com/magnus919/groktocrawl-x/issues/308), [#309 compatibility](https://github.com/magnus919/groktocrawl-x/issues/309), [#310 migration and rollback](https://github.com/magnus919/groktocrawl-x/issues/310), [#311 operational pilot](https://github.com/magnus919/groktocrawl-x/issues/311), [#312 adoption decision](https://github.com/magnus919/groktocrawl-x/issues/312) | In progress. The September 22 window ended before checkpoint 1 when a separate model test changed the candidate agent image and model alias. The restored current-main candidate passed a checkpoint on `general`; the owner then pinned LiteLLM `free` for the experimental candidate only, ending that window. The new [checkpoint 0](evidence/replacement-rehearsal/2026-09-23-free-model-checkpoint-0/README.md) passed all 12 operations on the unchanged runtime revision. The current window has 12/30 successful operations and 1/3 checkpoints. Checkpoint 1 is eligible after September 26 at 00:09 UTC, and checkpoint 2 plus decision after September 30 at 00:09 UTC, provided the runtime and configuration remain unchanged. |
