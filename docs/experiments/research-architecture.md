...
| W8 | Adaptively acquire sufficient evidence / retrieval + research owner | W7 decision | **In progress.** The [retrieval comparison](enterprise-evaluation/w8-retrieval-comparison-2026-09-11.md) retained current SlopSearX after broader engine fan-out added no known-source recall and increased latency. Fixed-query retrieval is complete; bounded query planning, a blinded source-equivalence audit, diversity and freshness studies remain. SlopSearX changes must be additive, optional, generally useful and backward compatible. | 5–9 days plus observation |
