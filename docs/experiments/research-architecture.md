...
| W9 | Rehearse the replacement candidate / maintainer + operations owner | W8; accepted deployment manifest | **In progress.** The isolated candidate is frozen and deployed, and the matched compatibility comparison passed all declared journeys in three runs per arm. Migration and rollback now pass with PostgreSQL authority and a retained Qdrant fallback. Complete the bounded side-by-side pilot and publish the evidence-based architecture/adoption decision | 7-day observation window plus active setup and review |
| W10 | Harden adaptive research policy / research owner | W9 candidate freeze; W8 source-equivalence evidence | Compare fixed retrieval with gap-triggered query generation, proposal gates, marginal-value admission, and deterministic stopping. Keep fixed-query retrieval as the default unless the matched evaluation demonstrates better research value within bounds. | Active experiment after the W9 candidate freeze |
...
| W9 | [Replacement rehearsal](https://github.com/magnus919/groktocrawl-x/milestone/8) | [#308 deployment](https://github.com/magnus919/groktocrawl-x/issues/308), [#309 compatibility](https://github.com/magnus919/groktocrawl-x/issues/309), [#310 migration and rollback](https://github.com/magnus919/groktocrawl-x/issues/310), [#311 operational pilot](https://github.com/magnus919/groktocrawl-x/issues/311), [#312 adoption decision](https://github.com/magnus919/groktocrawl-x/issues/312) | In progress; the [isolated candidate freeze](evidence/replacement-rehearsal/2026-09-11-candidate-freeze/) verifies all ten services and one coherent HTTP/SSE/CLI/MCP artifact journey at an exact revision. The [matched compatibility comparison](evidence/replacement-rehearsal/2026-09-11-compatibility/) passed all declared journeys in three runs per arm without a candidate-only regression. The [migration and rollback rehearsal](evidence/replacement-rehearsal/2026-09-11-migration-rollback/) and its post-merge Runtime CI passed; ADR-0079 is accepted and Qdrant remains through the rollback window. The bounded pilot began at 2026-09-11T17:26:19Z; checkpoint 0 passed 12 representative requests. It cannot complete before 2026-09-18T17:26:19Z. The remaining checkpoints and adoption decision remain. |
| W10 | [Adaptive research policy hardening](https://github.com/magnus919/groktocrawl-x/milestone/9) | [#314 bounded adaptive-query policies](https://github.com/magnus919/groktocrawl-x/issues/314) | In progress. The Academic/Comprehensive research-methodology audit now governs the study. The brief, inclusion and exclusion rules, 12-case challenge stratum, 24-case W8 anchor, five policies, replacement gates, source ledger, competing-hypothesis analysis, and sensitivities are frozen. Invalid launches remain preserved with reasons and digests. Proposal admission is bound to the planner's preserved open-gap state. Sequential trials now preserve both the interim judgment that controls stopping and the separate final blind score; their disagreement is reported as an exploratory stop-reliability diagnostic and sent to adjudication without changing the frozen replacement gates. The refrozen 180-trial challenge runs next, followed by the 360-trial anchor, adjudication, synthesis, and ADR decision. |
| W11 | [SlopSearX research substrate integration](https://github.com/magnus919/groktocrawl-x/milestone/10) | [#318](https://github.com/magnus919/groktocrawl-x/issues/318) | Active; the scored comparison waits for W10. The newly installed HAL2000 SlopSearX image exactly matches the pinned W11 0.5 baseline, so it expands the candidate surface without restarting W10. Its opt-in adaptive continuation, entity grouping, saved-search reports, retrieval receipts and manifests, staged search, dependency dossiers, and artifact-to-workflow composition are separated by capability and score boundary. HTTP compatibility and all nine grant boundaries passed. All 40 deterministic cases now have exact proof from 120 local passes and three isolated-Valkey passes. Live provenance, entity projection, receipt-interruption, process-killed capture recovery, saved-search lifecycle, honest partial dependency-dossier, and snapshot-to-research-to-manifest composition gates passed. Controlled saved-search change detection remains deterministic evidence. GroktoCrawl owns user intent, evidence gaps, synthesis, and publication; SlopSearX owns bounded retrieval execution, immutable snapshots, provenance, and attempt accounting. Ordinary SearXNG behavior remains unchanged. |
