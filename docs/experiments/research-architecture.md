...
| W4 | Equivalent workflow backends / research + evaluation owner | W2, D7; W3 for persistence cases | **Current-workflow comparison complete; future substrate in progress:** the bounded comparison produced 720 conforming records. Adaptive replanning and dynamic specialist fan-out add 420 conforming future-scenario records; dynamic fan-out is the clearest LangGraph benefit so far. Durable human guidance, restart/checkpoint recovery, forks, and capability substitution remain before ADR-0073 review | 3–5 days plus future-capability experiment |
...
| W4 | [Runtime comparison](https://github.com/magnus919/groktocrawl-x/milestone/2) | [#110](https://github.com/magnus919/groktocrawl-x/issues/110), [#245](https://github.com/magnus919/groktocrawl-x/issues/245) | The bounded comparison recorded 720 conforming runs and retains the imperative reference. The future study specification is implemented for adaptive replanning and dynamic specialist fan-out, with [420 additional conforming records](evidence/future-runtime/2026-09-09/). Dynamic fan-out is the first material LangGraph advantage; framework-specific state and reducers remain costs. Scenarios 3–5—durable guidance/restart, checkpoint forks, and model/search substitution—remain before ADR-0073 review. |
