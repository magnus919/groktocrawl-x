...
| W8 | Adaptively acquire sufficient evidence / retrieval + research owner | W7 decision | **In progress.** The [retrieval comparison](enterprise-evaluation/w8-retrieval-comparison-2026-09-11.md) retained current SlopSearX. The [bounded planning comparison](enterprise-evaluation/w8-adaptive-planning-outcome-2026-09-11.md) improved exact known-source recall from 17 to 20 of 44, but its all-weak stopping judgment made 45 extra searches indiscriminately; retain query formulation as a recovery tool and reject this stopping policy. A blinded source-equivalence audit, diversity and freshness studies remain. SlopSearX changes must be additive, optional, generally useful and backward compatible. | 5–9 days plus observation |
