...
| W8 | Adaptively acquire sufficient evidence / retrieval + research owner | W7 decision | **In progress.** The [retrieval comparison](enterprise-evaluation/w8-retrieval-comparison-2026-09-11.md) retained current SlopSearX. The [bounded planning comparison](enterprise-evaluation/w8-adaptive-planning-outcome-2026-09-11.md) retained query formulation as a recovery tool but rejected indiscriminate model stopping. The [diversity comparison](enterprise-evaluation/w8-source-diversity-outcome-2026-09-11.md) selects bounded quality and publisher independence, while deliberate opposition remains conditional. A blinded source-equivalence audit and freshness study remain. SlopSearX changes must be additive, optional, generally useful and backward compatible. | 5–9 days plus observation |
