...
| W7 | Evaluate, pilot and decide / maintainer + evaluation owner | W5, W6, D7 | **In progress.** W1 rejected Candidate B. [Issue #280](https://github.com/magnus919/groktocrawl-x/issues/280) and proposed [ADR-0080](../adr/0080-construct-source-bound-answer-units.md) define a lean source-bound successor. Freeze it before independent curation of a fresh held-out packet, then run the fail-closed comparison and decide continue, revise, or stop. | 2–4 days plus observation |
