...
| W12 | [Research agent contracts and value experiments](https://github.com/magnus919/groktocrawl-x/milestone/11) | [#327 narrow SlopSearX provenance adapter](https://github.com/magnus919/groktocrawl-x/issues/327), [#321–#325 value experiments](https://github.com/magnus919/groktocrawl-x/milestone/11), [SlopSearX #387 caller completion](https://github.com/magnus919/SlopSearX/issues/387) | In progress. The narrow least-privilege receipt/manifest adapter is merged. W12.1 rejects universal typed Research Mission intake; proposed [ADR-0083](../adr/0083-retain-prose-intake-over-universal-research-missions.md) retains prose intake. W12.2 rejects the tested default longitudinal Research Thread: the validated [evidence packet](evidence/research-thread/w12.2-final/00-index.md) shows lower fully observed accuracy, 23% more latency, 51% more tokens, and two stale-current leaks. Proposed [ADR-0084](../adr/0084-retain-independent-research-roots-over-default-threads.md) retains independent roots and explicit comparisons. W12.3–W12.5 remain open. |
