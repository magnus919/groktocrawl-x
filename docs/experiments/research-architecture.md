...
| W9 | Rehearse the replacement candidate / maintainer + operations owner | W8; accepted deployment manifest | **In progress.** Candidate freeze, matched compatibility, migration and rollback, PostgreSQL authority, pgvector serving, independent agent-use repairs, and the bounded similarity decision have passed. The experimental candidate remains on LiteLLM `free` at runtime revision `46a528228b1365189cdd38d0bcdb12109a8dc763`. [Checkpoint 0](evidence/replacement-rehearsal/2026-09-23-free-model-checkpoint-0/README.md) and [checkpoint 1](evidence/replacement-rehearsal/2026-09-26-free-model-checkpoint-1/README.md) each passed all 12 operations; current credit is 24/30 operations and 2/3 checkpoints. pgvector serves and Qdrant remains rollback ready. Checkpoint 2 and the decision are eligible no earlier than September 30 at 00:09 UTC, provided the runtime and configuration remain unchanged. | Earliest completion 2026-09-30T00:09:25.966168Z, conditional on unchanged configuration and remaining gates |
...
| W9 | [Replacement rehearsal](https://github.com/magnus919/groktocrawl-x/milestone/8) | [#308 deployment](https://github.com/magnus919/groktocrawl-x/issues/308), [#309 compatibility](https://github.com/magnus919/groktocrawl-x/issues/309), [#310 migration and rollback](https://github.com/magnus919/groktocrawl-x/issues/310), [#311 operational pilot](https://github.com/magnus919/groktocrawl-x/issues/311), [#312 adoption decision](https://github.com/magnus919/groktocrawl-x/issues/312) | In progress. The previous general-model window ended when the owner pinned LiteLLM `free` for the experimental candidate only. The new window passed [checkpoint 0](evidence/replacement-rehearsal/2026-09-23-free-model-checkpoint-0/README.md) on September 23 and [checkpoint 1](evidence/replacement-rehearsal/2026-09-26-free-model-checkpoint-1/README.md) on September 26; each completed all 12 operations on runtime revision `46a528228b1365189cdd38d0bcdb12109a8dc763`. The current window has 24/30 successful operations and 2/3 checkpoints. Checkpoint 2 and the decision are eligible after September 30 at 00:09 UTC, provided the runtime and configuration remain unchanged. |
