...
| W9 | Rehearse the replacement candidate / maintainer + operations owner | W8; accepted deployment manifest | **In progress.** The isolated candidate is deployed, and the matched compatibility comparison passed all declared journeys in three runs per arm. Migration and rollback pass with PostgreSQL authority and a retained Qdrant fallback. Live audits exposed and repaired streaming search, candidate Parse wiring, semantic timeout, staged Parse metadata, the public staged-upload reservation, a retired deployment model alias, crawl outcome projection, and barrier classification. The bounded similarity study retained raw cosine retrieval. The September 20 window passed checkpoint 0 but was superseded by agent and search-configuration changes. A clean current-main candidate at revision `46a528228b1365189cdd38d0bcdb12109a8dc763` passed a [new checkpoint 0](evidence/replacement-rehearsal/2026-09-22-current-main-checkpoint-0/README.md): 12/12 operations, 1/3 checkpoints, model `general`, pgvector serving, and Qdrant rollback ready. Earlier windows remain operational evidence only. Checkpoint 1 is due no earlier than September 25, and the seven-day gate no earlier than September 29. | Earliest completion 2026-09-29T16:47:25.742584Z, conditional on unchanged configuration and remaining gates |
| W10 | Harden adaptive research policy / research owner | W9 candidate freeze; W8 source-equivalence evidence | **Complete.** The [W10 evidence package](evidence/adaptive-policy/w10-final/00-index.md) accounts for all 540 trials and 4,487 blinded adjudications. The full bounded policy lost 33.3 percentage points of weighted closure on the W8 anchor, only 11.1% of follow-ups produced an evidence gain, and no challenge type passed. [ADR-0081](../adr/0081-select-a-bounded-adaptive-research-policy.md) keeps fixed retrieval as the default while preserving the state contracts for future policy experiments. | Complete 2026-09-12 |
| W11 | Evaluate SlopSearX research workflows / retrieval + research owner | W10 evidence and SlopSearX 0.5 capability freeze | Compare GroktoCrawl-owned flat-search coordination with caller-directed continuation, bounded staged search, and receipt/manifest/entity integration. Keep one research owner, preserve ordinary SearXNG behavior, and evaluate saved searches and dependency dossiers as separate capability slices. | 3–5 days |
| W13 | Normalize autonomous barrier recovery / scraping owner | ADR-0015, ADR-0044; W9 candidate remains frozen | Centralize a bounded, classified recovery ladder in scraper-svc; expose sanitized receipts; prove direct scrape, agent, crawl, CLI, and MCP inherit terminal semantics without caller-selected countermeasures | 2–4 days |
...
| W9 | [Replacement rehearsal](https://github.com/magnus919/groktocrawl-x/milestone/8) | [#308 deployment](https://github.com/magnus919/groktocrawl-x/issues/308), [#309 compatibility](https://github.com/magnus919/groktocrawl-x/issues/309), [#310 migration and rollback](https://github.com/magnus919/groktocrawl-x/issues/310), [#311 operational pilot](https://github.com/magnus919/groktocrawl-x/issues/311), [#312 adoption decision](https://github.com/magnus919/groktocrawl-x/issues/312) | In progress. Candidate freeze, matched compatibility, migration/rollback, PostgreSQL authority, pgvector serving, independent agent-use repairs, and the bounded similarity decision have passed. Earlier failed and superseded windows remain retained evidence. The September 20 window passed checkpoint 0 but ended before checkpoint 1 after a candidate agent replacement; subsequent Semantic Scholar key wiring changed the candidate search configuration. The new current-main baseline passed checkpoint 0 on September 22 with 12/30 current-window operations and 1/3 checkpoints. The prior 12 operations and dates do not count toward this window; checkpoint 1 is due after 72 hours and checkpoint 2 after seven days, provided the configuration remains unchanged. |
...
| W12 | [Research agent contracts and value experiments](https://github.com/magnus919/groktocrawl-x/milestone/11) | [#327 narrow SlopSearX provenance adapter](https://github.com/magnus919/groktocrawl-x/issues/327), [#321–#325 value experiments](https://github.com/magnus919/groktocrawl-x/milestone/11), [SlopSearX #387 caller completion](https://github.com/magnus919/SlopSearX/issues/387) | Complete pending review. W12.1 rejects universal typed Research Mission intake; proposed [ADR-0083](../adr/0083-retain-prose-intake-over-universal-research-missions.md) retains prose intake. W12.2 rejects default longitudinal thread injection; proposed [ADR-0084](../adr/0084-retain-independent-research-roots-over-default-threads.md) retains independent roots and explicit comparisons. W12.3 supports bounded semantic verification before source-bound claim publication: its [evidence packet](evidence/claim-verification/w12.3-final/00-index.md) shows zero critical false accepts, zero missed contradictions, zero false rejections, and 22.3-second high-risk p95 latency; proposed [ADR-0085](../adr/0085-add-independent-semantic-verification-before-claim-publication.md) defines an experimental rollout. W12.4 supports an opt-in evidence-obligation controller: its [evidence packet](evidence/evidence-obligations/w12.4-final/00-index.md) proves deterministic closure and stopping behavior under frozen replay, while proposed [ADR-0086](../adr/0086-add-bounded-evidence-obligation-continuation.md) keeps fixed retrieval as the stable default pending live calibration. W12.5 rejects generic specialist fan-out: its [evidence packet](evidence/specialist-value/w12.5-final/00-index.md) records improved structural coverage but sub-threshold usefulness and reviewer failures; proposed [ADR-0087](../adr/0087-retain-generalist-over-generic-specialist-fanout.md) preserves typed handoffs for narrower future trials. |
| W13 | [Pervasive autonomous barrier recovery](https://github.com/magnus919/groktocrawl-x/milestone/12) | [#363](https://github.com/magnus919/groktocrawl-x/issues/363) | Complete in [PR #364](https://github.com/magnus919/groktocrawl-x/pull/364). Accepted [ADR-0088](../adr/0088-centralize-bounded-barrier-recovery.md) makes scraper-svc the owner of one classified, bounded recovery ladder; direct scrape, agent, crawl, CLI, and MCP now inherit the same terminal semantics and sanitized recovery receipt. The active W9 deployment remains frozen on its observation revision. |
