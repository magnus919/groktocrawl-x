...
| W4 | Equivalent workflow backends / research + evaluation owner | W2, D7; W3 for persistence cases | **Decision review ready:** the optional LangGraph adapter and two 30-repetition-per-workload paired series produced 720 records with zero conformance failures. The [engineering assessment](runtime-comparison/report.md) recommends the imperative controller because LangGraph added overhead without removing application-owned policy or recovery complexity. ADR-0073 decider review remains open | 3–5 days |
...
| W4 | [Runtime comparison](https://github.com/magnus919/groktocrawl-x/milestone/2) | [#110](https://github.com/magnus919/groktocrawl-x/issues/110) | Harness merged by [PR #115](https://github.com/magnus919/groktocrawl-x/pull/115); first and repeated paired fixture measurements are recorded in the [2026-09-08](evidence/runtime-comparison/2026-09-08/) and [2026-09-09](evidence/runtime-comparison/2026-09-09/) packets, with zero conformance failures. The assessment recommends retaining the imperative runtime; ADR-0073 decider review remains open |
