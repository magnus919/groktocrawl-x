...
| W9 | Rehearse the replacement candidate / maintainer + operations owner | W8; accepted deployment manifest | **In progress.** The isolated candidate is frozen and deployed, and the matched compatibility comparison passed all declared journeys in three runs per arm. Migration and rollback now pass with PostgreSQL authority and a retained Qdrant fallback. The first pilot window produced failed operational evidence when volatile private-file paths prevented restart. A corrected loopback window passed checkpoint 0, then ended when the owner selected normal Hermes traffic as the stronger pilot workload. The real-use window began `2026-09-19T13:42:50Z`; its LAN checkpoint 0 passed all 12 declared operations. Complete checkpoints at 72 and 168 elapsed hours, then publish the evidence-based architecture/adoption decision. | Earliest completion `2026-09-26T13:42:50Z` plus active review |
...
| W9 | [Replacement rehearsal](https://github.com/magnus919/groktocrawl-x/milestone/8) | [#308 deployment](https://github.com/magnus919/groktocrawl-x/issues/308), [#309 compatibility](https://github.com/magnus919/groktocrawl-x/issues/309), [#310 migration and rollback](https://github.com/magnus919/groktocrawl-x/issues/310), [#311 operational pilot](https://github.com/magnus919/groktocrawl-x/issues/311), [#312 adoption decision](https://github.com/magnus919/groktocrawl-x/issues/312) | In progress. The candidate freeze, matched compatibility comparison, migration/rollback rehearsal, and PostgreSQL decision passed. The host-restart outage and the corrected loopback checkpoint remain retained evidence. The owner selected normal Hermes traffic as the stronger operational workload, so API and MCP ports now publish on trusted host interfaces and the window restarted on 2026-09-19. LAN checkpoint 0 passed; checkpoint 1 cannot count before `2026-09-22T13:42:50Z`, and the final checkpoint and adoption review cannot count before `2026-09-26T13:42:50Z`. |
