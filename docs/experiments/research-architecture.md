...
| W9 | Rehearse the replacement candidate / maintainer + operations owner | W8; accepted deployment manifest | Freeze and deploy the isolated candidate, prove incumbent compatibility, rehearse migration and rollback, complete the bounded side-by-side pilot, and publish the evidence-based architecture/adoption decision | 7-day observation window plus active setup and review |
