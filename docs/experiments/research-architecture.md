...
| W11 | [SlopSearX research substrate integration](https://github.com/magnus919/groktocrawl-x/milestone/10) | [#318](https://github.com/magnus919/groktocrawl-x/issues/318) | Planned after W10. SlopSearX 0.5 ships opt-in adaptive continuation, entity grouping, saved-search reports, retrieval receipts and manifests, staged search, and dependency dossiers. W11 will test a single-owner boundary in which GroktoCrawl owns user intent, evidence gaps, synthesis, and publication while SlopSearX owns bounded retrieval execution, immutable snapshots, provenance, and attempt accounting. Ordinary SearXNG behavior remains unchanged. |
