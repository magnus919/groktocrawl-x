...
| W12 | [Research agent contracts and value experiments](https://github.com/magnus919/groktocrawl-x/milestone/11) | [#327 narrow SlopSearX provenance adapter](https://github.com/magnus919/groktocrawl-x/issues/327), [#321–#325 value experiments](https://github.com/magnus919/groktocrawl-x/milestone/11), [SlopSearX #387 caller completion](https://github.com/magnus919/SlopSearX/issues/387) | In progress. The narrow least-privilege receipt/manifest adapter is implemented, live-verified, and merged. W12.1 v1 was frozen and preflighted, but its first measured launch exceeded the failure guardrail and is excluded. The bounded v2 output/transport correction is frozen at a new exact revision; matched control/treatment preflight is next. Ordinary HTTP search remains the default. Broad continuation stays blocked until execution exhaustion and caller completion are durably separate and a new frozen comparison passes. |
