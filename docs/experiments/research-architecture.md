...
authoritative. Consolidation is useful only if PostgreSQL is also adopted as
the artifact authority; application-level reconciliation and shared-database
interference evidence remain open before a provider decision.
...
| W3 | [Retention and reuse](https://github.com/magnus919/groktocrawl-x/milestone/1) | [#108 export](https://github.com/magnus919/groktocrawl-x/issues/108), [#109 import](https://github.com/magnus919/groktocrawl-x/issues/109), [#122 restore](https://github.com/magnus919/groktocrawl-x/issues/122), [#201 vector gates](https://github.com/magnus919/groktocrawl-x/issues/201) | Bounded export/import and restore/deletion continuity are complete through [PR #107](https://github.com/magnus919/groktocrawl-x/pull/107), [PR #114](https://github.com/magnus919/groktocrawl-x/pull/114) and [PR #125](https://github.com/magnus919/groktocrawl-x/pull/125); vector fixture, concurrency, restart, restore, fault, scale, phase-attributed resource, dimension-migration, cutover and rollback evidence are published. Both isolated providers preserved scoped retrieval and deletion state through cutover and rollback. The operational comparison recommends a shadow-pgvector pilot; implementation, shared-database interference evidence, and the reviewed provider decision remain open in #201 |
