...
| W6 | [Verified client protocols](https://github.com/magnus919/groktocrawl-x/milestone/4) | [#112](https://github.com/magnus919/groktocrawl-x/issues/112) | Contract, golden traces and opt-in capabilities merged by [PR #119](https://github.com/magnus919/groktocrawl-x/pull/119), [PR #120](https://github.com/magnus919/groktocrawl-x/pull/120) and [PR #121](https://github.com/magnus919/groktocrawl-x/pull/121); CLI/MCP capability-discovery parity is now implemented, while run/artifact/evidence/session adapters and authorization/deletion races remain open |
