...
| W10 | [Adaptive research policy hardening](https://github.com/magnus919/groktocrawl-x/milestone/9) | [#314 bounded adaptive-query policies](https://github.com/magnus919/groktocrawl-x/issues/314) | In progress. The Academic/Comprehensive research-methodology audit now governs the study. The brief, inclusion and exclusion rules, 12-case challenge stratum, 24-case W8 anchor, five policies, replacement gates, source ledger, competing-hypothesis analysis, and sensitivities are frozen. Invalid launches remain preserved with reasons and digests. The latest correction binds proposal admission to the planner's preserved open-gap state; focused tests and a two-arm live reproduction passed. The refrozen 180-trial challenge runs next, followed by the 360-trial anchor, adjudication, synthesis, and ADR decision. |
