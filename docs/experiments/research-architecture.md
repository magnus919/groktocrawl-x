...
| W1 | Architecture decision pack and baseline / architecture + evaluation owner | W0 identity; execution lanes needed for measured baseline | Review D1–D3/D6 contracts, frame D4/D5 alternatives, accept D7 experiment protocol; pin baseline behavior and decisions with measurable unresolved questions. The original packet, isolation review, incumbent run, and [primary semantic review](enterprise-evaluation/w1-incumbent-semantic-review-2026-09-09.md) are complete. Proposed bounds and execution controls are pinned. Candidate B now has strict schema generation, one ordered semantic review batch, and deterministic render auditing. A separate 30-case exposed evaluator refresh graded 29/30 cases, retained one invalid-citation failure, and removed request-level failures, showing that the local route has recovered enough for another bounded candidate probe. That refresh did not execute the evidence-first journey. Candidate B policy 3 has now produced a complete fixed-source terminal manifest after mechanically decidable structure and conflict checks moved to application-owned verification. This establishes candidate-core viability; Candidate B is frozen at `36f999514cf0dc8eb3164c4cac50a7ba0002618f` under policy `real-research-pilot/3`; the exposed same-model grades remain diagnostic rather than quality evidence, and live acquisition remains a separate reliability issue. A fresh [replacement packet](enterprise-evaluation/w1-replacement-packet-2026-09-10.md) was independently curated after the freeze, passes structural validation, and has Magnus's isolation approval. Adjudication and explicit comparison authorization remain open. | 3–5 days |
