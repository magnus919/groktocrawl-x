...
|---|---|---|---|
| W0–W2 | [Foundation history](https://github.com/magnus919/groktocrawl-x/milestone/6) | [#1](https://github.com/magnus919/groktocrawl-x/issues/1), [#116](https://github.com/magnus919/groktocrawl-x/issues/116) | Validator merged by [PR #117](https://github.com/magnus919/groktocrawl-x/pull/117); the exposed local self-check is recorded by [PR #157](https://github.com/magnus919/groktocrawl-x/pull/157); Magnus approved the W1 packet proposal on 2026-09-08, and the separately sealed packet, incumbent baseline, and reviewed held-out gate remain open |
