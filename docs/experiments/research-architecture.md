...
| W3 | [Retention and reuse](https://github.com/magnus919/groktocrawl-x/milestone/1) | [#108 export](https://github.com/magnus919/groktocrawl-x/issues/108), [#109 import](https://github.com/magnus919/groktocrawl-x/issues/109), [#122 restore](https://github.com/magnus919/groktocrawl-x/issues/122) | Bounded export/import resolved by merged [PR #107](https://github.com/magnus919/groktocrawl-x/pull/107) and [PR #114](https://github.com/magnus919/groktocrawl-x/pull/114); partial restore/deletion evidence is recorded in [the evidence packet](research-restore-evidence.md), while expiry reconciliation and interrupted/corrupt restore cases remain open under #122 |
