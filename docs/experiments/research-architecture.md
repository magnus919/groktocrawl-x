...
| W4 | Equivalent workflow backends / research + evaluation owner | W2, D7; W3 for persistence cases | **Current-workflow comparison complete; future substrate in progress:** 720 bounded-workflow records, 420 replanning/specialist records, and 60 durable-guidance records conform. Dynamic fan-out and native interrupt continuation now show concrete LangGraph value. Checkpoint forks and capability substitution remain before ADR-0073 review | 3–5 days plus future-capability experiment |
...
| W4 | [Runtime comparison](https://github.com/magnus919/groktocrawl-x/milestone/2) | [#110](https://github.com/magnus919/groktocrawl-x/issues/110), [#245](https://github.com/magnus919/groktocrawl-x/issues/245) | The bounded comparison recorded 720 conforming runs. Replanning and dynamic specialists add [420 conforming records](evidence/future-runtime/2026-09-09/). Durable human guidance adds [60 restart/resume records](evidence/future-runtime/2026-09-10-guidance/) and establishes native interrupts as a concrete LangGraph advantage while retaining W5 authority. Checkpoint forks and capability substitution remain before ADR-0073 review. |
