...
| W8 | Adaptively acquire sufficient evidence / retrieval + research owner | W7 decision | **In progress.** Benchmark long-tail retrieval and ranking; evaluate bounded replanning and machine-checkable stopping; test source diversity and contradiction discovery; exercise freshness, canonical identity and link rot. SlopSearX changes must be additive, optional, generally useful and backward compatible. | 5–9 days plus observation |
