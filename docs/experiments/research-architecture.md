...
| W12 | [Research agent contracts and value experiments](https://github.com/magnus919/groktocrawl-x/milestone/11) | [#327 narrow SlopSearX provenance adapter](https://github.com/magnus919/groktocrawl-x/issues/327), [#321–#325 value experiments](https://github.com/magnus919/groktocrawl-x/milestone/11), [SlopSearX #387 caller completion](https://github.com/magnus919/SlopSearX/issues/387) | In progress. The narrow least-privilege receipt/manifest adapter is merged. W12.1 is complete: the validated [evidence packet](evidence/research-mission/w12.1-final/00-index.md) rejects universal typed Research Mission intake. It passed the difficult-case gate in one of three repetitions; intake achieved 40% action accuracy, 2.9/100 mean field recall, and 11 hard-boundary failures. Proposed [ADR-0083](../adr/0083-retain-prose-intake-over-universal-research-missions.md) retains prose intake while preserving narrower typed contracts for future experiments. Ordinary HTTP search remains the default. W12.2–W12.5 remain open. |
