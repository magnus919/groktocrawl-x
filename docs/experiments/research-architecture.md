...
| W9 | Rehearse the replacement candidate / maintainer + operations owner | W8; accepted deployment manifest | **In progress.** Candidate freeze, matched compatibility, migration and rollback, PostgreSQL authority, pgvector serving, independent agent-use repairs, and the bounded similarity decision have passed. The former `general` pilot window ended when the owner pinned LiteLLM `free` for the experimental candidate only. Current runtime revision `46a528228b1365189cdd38d0bcdb12109a8dc763` passed [checkpoint 0](evidence/replacement-rehearsal/2026-09-23-free-model-checkpoint-0/README.md) with all 12 operations. Credit is 12/30 operations and 1/3 checkpoints; pgvector serves and Qdrant remains rollback ready. Checkpoint 1 is due no earlier than September 26 at 00:09 UTC, and checkpoint 2 plus the decision no earlier than September 30 at 00:09 UTC, provided the runtime and configuration remain unchanged. | Earliest completion 2026-09-30T00:09:25.966168Z, conditional on unchanged configuration and remaining gates |
