...
| W4 | Equivalent workflow backends / research + evaluation owner | W2, D7; W3 for persistence cases | **Current-workflow comparison complete; future substrate in progress:** 720 bounded-workflow records, 420 replanning/specialist records, 60 durable-guidance records, and 60 fork records conform. Dynamic fan-out, native interrupt continuation, and checkpoint forks show concrete LangGraph value. Capability substitution remains before ADR-0073 review | 3–5 days plus future-capability experiment |
...
| W4 | [Runtime comparison](https://github.com/magnus919/groktocrawl-x/milestone/2) | [#110](https://github.com/magnus919/groktocrawl-x/issues/110), [#245](https://github.com/magnus919/groktocrawl-x/issues/245) | The bounded comparison recorded 720 conforming runs. Replanning and dynamic specialists add [420 records](evidence/future-runtime/2026-09-09/), durable guidance adds [60 restart/resume records](evidence/future-runtime/2026-09-10-guidance/), and checkpoint forks add [60 isolated parent/child records](evidence/future-runtime/2026-09-10-forks/). Native interrupts and checkpoint history now provide concrete LangGraph advantages while application authority controls reuse. Capability substitution remains before ADR-0073 review. |
