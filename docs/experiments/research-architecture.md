...
[issue #227](https://github.com/magnus919/groktocrawl-x/issues/227) track initial
reconciliation and shared-database interference evidence. Consolidation is
useful only if PostgreSQL is also adopted as the artifact authority; the live
pilot evidence and reviewed provider decision remain open.
...
| W1 | Architecture decision pack and baseline / architecture + evaluation owner | W0 identity; execution lanes needed for measured baseline | Review D1–D3/D6 contracts, frame D4/D5 alternatives, accept D7 experiment protocol; pin baseline behavior and decisions with measurable unresolved questions. The [W1 baseline packet proposal](enterprise-evaluation/w1-baseline-packet-proposal.md), [held-out isolation approval](enterprise-evaluation/w1-heldout-approval-2026-09-08.md), and [baseline input record](enterprise-evaluation/w1-baseline-inputs-2026-09-08.md) are complete. Numerical bounds, scoring protocol, candidate arm identities, and comparison authorization remain open. | 3–5 days |
...
| W4 | Equivalent workflow backends / research + evaluation owner | W2, D7; W3 for persistence cases | **Adapter implemented in merged PR #150:** optional LangGraph runtime runs the same typed fixture policy beside the imperative reference; paired 30-repetition-per-workload measurements are recorded in [the 2026-09-08 packet](evidence/runtime-comparison/2026-09-08/) and [the 2026-09-09 repeat packet](evidence/runtime-comparison/2026-09-09/), both with zero conformance failures. W1 bounds review and the D4 decision remain open | 3–5 days |
