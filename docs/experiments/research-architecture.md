...
The first successful bounded fixture packet is recorded in the [storage evaluation evidence](evidence/storage-vector-evaluation/2026-09-08/); the first three-round packet is in [the repeated-round evidence](evidence/storage-vector-evaluation/2026-09-08-rounds-3/).
...
| W1 | Architecture decision pack and baseline / architecture + evaluation owner | W0 identity; execution lanes needed for measured baseline | Review D1–D3/D6 contracts, frame D4/D5 alternatives, accept D7 experiment protocol; pin baseline behavior and decisions with measurable unresolved questions. The current reviewable packet is [the W1 baseline proposal](enterprise-evaluation/w1-baseline-packet-proposal.md); the fail-closed preflight remains unresolved. | 3–5 days |
...
| W4 | Equivalent workflow backends / research + evaluation owner | W2, D7; W3 for persistence cases | **Adapter implemented in merged PR #150:** optional LangGraph runtime runs the same typed fixture policy beside the imperative reference; exact dependency pin, W1 baseline authorization, paired conformance/overhead measurements and D4 decision remain open | 3–5 days |
...
|---|---|---|---|
| W0–W2 | [Foundation history](https://github.com/magnus919/groktocrawl-x/milestone/6) | [#1](https://github.com/magnus919/groktocrawl-x/issues/1), [#116](https://github.com/magnus919/groktocrawl-x/issues/116) | Validator merged by [PR #117](https://github.com/magnus919/groktocrawl-x/pull/117); the exposed local self-check is recorded by [PR #157](https://github.com/magnus919/groktocrawl-x/pull/157), while W1/W2 acceptance gates and the reviewed held-out baseline remain open |
