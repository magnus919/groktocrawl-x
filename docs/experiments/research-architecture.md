...
| W10 | [Adaptive research policy hardening](https://github.com/magnus919/groktocrawl-x/milestone/9) | [#314 bounded adaptive-query policies](https://github.com/magnus919/groktocrawl-x/issues/314) | In progress. The research brief, 12-case challenge stratum, 24-case W8 anchor, five policies, replacement gates, source ledger, and sensitivity plan are refrozen. Methodology audits excluded launches that assessed stopping only after dispatch, retained a nonterminal completion label, or attributed an acquired page to its earliest sighting instead of the follow-up that promoted it. The corrected full policy now assesses before redispatch, requires an explicit terminal reason, and records the search that caused each acquisition. Live smokes exercised the no-gain stop, planner-complete path, and acquisition attribution. The valid 180-trial challenge is active from source `e054ac84612a5d930c2f23e33e69f9afe82e4d8c`; the 360-trial anchor, adjudication, synthesis, and ADR decision follow. |
