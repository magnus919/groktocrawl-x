...
| W4 | [Runtime comparison](https://github.com/magnus919/groktocrawl-x/milestone/2) | [#110](https://github.com/magnus919/groktocrawl-x/issues/110), [#245](https://github.com/magnus919/groktocrawl-x/issues/245) | Harness merged by [PR #115](https://github.com/magnus919/groktocrawl-x/pull/115); first and repeated paired fixture measurements are recorded in the [2026-09-08](evidence/runtime-comparison/2026-09-08/) and [2026-09-09](evidence/runtime-comparison/2026-09-09/) packets, with zero conformance failures. The imperative controller is the reference for today's bounded workflow. Issue #245 keeps the long-term substrate decision open. Its [future-scenario specification](future-runtime-scenarios.md) defines adaptive replanning, specialist subgraphs, human interrupts, checkpoint recovery, state forks, model/search substitution, shared authority boundaries, and measurements before implementation or ADR-0073 decider review. |
