...
its contents. Normal source operations accept schema versions 1, 2 and 3; there is no automatic
...
schema 1, 2 and 3 and removes dependent revision/publication payloads during root deletion.
