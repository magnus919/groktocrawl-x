...
- SLOPSEARX_MCP_PORT
- SLOPSEARX_PROVENANCE_MCP_URL
- SLOPSEARX_PROVENANCE_PROFILE
- SLOPSEARX_PROVENANCE_SNAPSHOT_TTL_SECONDS
- SLOPSEARX_PROVENANCE_TOKEN
...
- SEARXNG_URL
- SEMANTIC_URL
- SEMANTIC_CLIENT_TIMEOUT_SECONDS
