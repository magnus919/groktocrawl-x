...
set -eu
case "${1:-}" in
  write|read|cleanup|adapter|revision|publication|rerender|export|publication-state|revision-state|source-state|restore-seed|restore-delete|restore-verify) phase=$1 ;;
